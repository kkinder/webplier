...
#
# Created: Tue Feb 19 16:55:45 2013
...
class Ui_SiteEditor(object):
    def setupUi(self, SiteEditor):
        ...
        self.gridLayout_2.addWidget(self.browseButton, 5, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.iconLocationLineEdit, 5, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.iconPreviewLabel, 7, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.iconStatusLabel, 6, 2, 1, 1)
